...
router.post('/verify-magic-link', async (req: Request, res: Response): Promise<Response | void> => {
...
router.post('/register', authMiddleware, adminMiddleware, async (req: AuthRequest, res: Response): Promise<Response | void> => {
