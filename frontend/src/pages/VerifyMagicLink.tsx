    ...
    useEffect(() => {
        ...
        const verifyToken = async () => {
            try {
                ...
                setStatus('error');
                setErrorMessage(
                    err.response?.data?.error || 'Invalid or expired magic link. Please request a new one.'
                );
            }
        };
                ...
                <div className="glass-card rounded-2xl p-8 sm:p-10">
                    ...
                    {status === 'verifying' && (
                        ...
                        >
                            <motion.div
                                ...
                                className="w-14 h-14 border-[3px] border-[var(--color-tan)] border-t-[var(--color-brown)] rounded-full mx-auto"
                            />
                            <div className="space-y-2">
                                <h2 className="text-xl font-medium text-[var(--foreground)] tracking-tight">
                                    Verifying your link
                                </h2>
                    ...
                    {status === 'success' && (
                        ...
                        >
                            <motion.div
                                ...
                                className="w-16 h-16 bg-[var(--color-tan)]/30 border border-[var(--color-tan)] rounded-full flex items-center justify-center mx-auto text-[var(--color-sage)] text-2xl font-bold"
                            >
                                ✓
                            </motion.div>
                            <div className="space-y-2">
                    ...
                    {status === 'error' && (
                        ...
                        >
                            ...
                            <button
                                onClick={() => navigate('/')}
                                className="mt-2 inline-flex items-center py-2.5 px-6 border border-transparent rounded-xl shadow-sm text-sm font-medium text-[var(--primary-fg)] bg-[var(--primary)] hover:opacity-90 focus:outline-none focus:ring-4 focus:ring-[var(--primary)]/20 transition-all active:scale-[0.98]"
                            >
                                Back to Sign In
